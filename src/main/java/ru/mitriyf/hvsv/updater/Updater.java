package ru.mitriyf.hvsv.updater;

import org.bukkit.configuration.file.YamlConfiguration;
import ru.mitriyf.hvsv.HvsV;
import ru.mitriyf.hvsv.updater.config.ConfigUpdater;
...
public class Updater {
    ...
    public Updater(HvsV plugin, Values values) {
        this.plugin = plugin;
    ...
    private void checkVersions() {
        try {
            URLConnection connection = new URL("https://github.com/mitriyf/HvsV/raw/refs/heads/main/updater/versions.yml").openConnection();
